[@kernelminds/scailo-sdk](../README.md) / [Exports](../modules.md) / IdentifierWithSearch
...
• **new IdentifierWithSearch**(`data?`): [`IdentifierWithSearch`](IdentifierWithSearch.md)
