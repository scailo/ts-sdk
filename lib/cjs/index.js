...
exports.getScailoClientForQCHubsService = getScailoClientForQCHubsService;
...
*/
function getScailoClientForQCHubsService(transport) {
    return (0, connect_1.createClient)(qc_hubs_scailo_connect_1.QCHubsService, transport);
}
/**
