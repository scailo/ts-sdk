 ...
 */
class PurchaseOrderPriceMatch extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         * Stores the family ID
         ...
         */
        this.debitedTotalValue = protobuf_1.protoInt64.zero;
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(PurchaseOrderPriceMatch, a, b);
    }
}
exports.PurchaseOrderPriceMatch = PurchaseOrderPriceMatch;
PurchaseOrderPriceMatch.runtime = protobuf_1.proto3;
PurchaseOrderPriceMatch.typeName = "Scailo.PurchaseOrderPriceMatch";
PurchaseOrderPriceMatch.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "family_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "vendor_uom_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 10, name: "ordered_primary", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 20, name: "ordered_secondary", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
 ...
 */
class PurchaseOrderPriceMatchList extends protobuf_1.Message {
    constructor(data) {
        super();
        /**
         * List of records
    ...
    static equals(a, b) {
        return protobuf_1.proto3.util.equals(PurchaseOrderPriceMatchList, a, b);
    }
}
exports.PurchaseOrderPriceMatchList = PurchaseOrderPriceMatchList;
PurchaseOrderPriceMatchList.runtime = protobuf_1.proto3;
PurchaseOrderPriceMatchList.typeName = "Scailo.PurchaseOrderPriceMatchList";
PurchaseOrderPriceMatchList.fields = protobuf_1.proto3.util.newFieldList(() => [
