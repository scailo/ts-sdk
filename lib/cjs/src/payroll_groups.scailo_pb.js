...
PayrollGroupsServiceCreateRequest.runtime = protobuf_1.proto3;
PayrollGroupsServiceCreateRequest.typeName = "Scailo.PayrollGroupsServiceCreateRequest";
PayrollGroupsServiceCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroupsServiceUpdateRequest.runtime = protobuf_1.proto3;
PayrollGroupsServiceUpdateRequest.typeName = "Scailo.PayrollGroupsServiceUpdateRequest";
PayrollGroupsServiceUpdateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroup.runtime = protobuf_1.proto3;
PayrollGroup.typeName = "Scailo.PayrollGroup";
PayrollGroup.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
class PayrollGroupsServiceItemCreateRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.payrollParamId = protobuf_1.protoInt64.zero;
        /**
         * The value type of the item
         *
         * @generated from field: Scailo.PAYROLL_GROUP_ITEM_VALUE_TYPE value_type = 20;
         */
        this.valueType = PAYROLL_GROUP_ITEM_VALUE_TYPE.PAYROLL_GROUP_ITEM_VALUE_TYPE_ANY_UNSPECIFIED;
        /**
         ...
         */
        this.basePayAddition = protobuf_1.protoInt64.zero;
        /**
         ...
         */
        this.amountPercentageOnWhichTaxApplicable = protobuf_1.protoInt64.zero;
        /**
...
PayrollGroupsServiceItemCreateRequest.runtime = protobuf_1.proto3;
PayrollGroupsServiceItemCreateRequest.typeName = "Scailo.PayrollGroupsServiceItemCreateRequest";
PayrollGroupsServiceItemCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
PayrollGroupsServiceItemUpdateRequest.runtime = protobuf_1.proto3;
PayrollGroupsServiceItemUpdateRequest.typeName = "Scailo.PayrollGroupsServiceItemUpdateRequest";
PayrollGroupsServiceItemUpdateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 20, name: "value_type", kind: "enum", T: protobuf_1.proto3.getEnumType(PAYROLL_GROUP_ITEM_VALUE_TYPE) },
    { no: 21, name: "base_pay_addition", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
PayrollGroupItem.runtime = protobuf_1.proto3;
PayrollGroupItem.typeName = "Scailo.PayrollGroupItem";
PayrollGroupItem.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "metadata", kind: "message", T: base_scailo_pb_js_1.EmployeeMetadata },
    { no: 3, name: "approval_metadata", kind: "message", T: base_scailo_pb_js_1.ApprovalMetadata },
...
PayrollGroupsList.runtime = protobuf_1.proto3;
PayrollGroupsList.typeName = "Scailo.PayrollGroupsList";
PayrollGroupsList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroupsItemsList.runtime = protobuf_1.proto3;
PayrollGroupsItemsList.typeName = "Scailo.PayrollGroupsItemsList";
PayrollGroupsItemsList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroupItemHistoryRequest.runtime = protobuf_1.proto3;
PayrollGroupItemHistoryRequest.typeName = "Scailo.PayrollGroupItemHistoryRequest";
PayrollGroupItemHistoryRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 10, name: "payroll_group_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 11, name: "payroll_param_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
]);
/**
...
class PayrollGroupsServicePaginationReq extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.sortKey = PAYROLL_GROUP_SORT_KEY.PAYROLL_GROUP_SORT_KEY_ID_UNSPECIFIED;
        /**
         * The status of this payroll group
         *
...
PayrollGroupsServicePaginationReq.runtime = protobuf_1.proto3;
PayrollGroupsServicePaginationReq.typeName = "Scailo.PayrollGroupsServicePaginationReq";
PayrollGroupsServicePaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroupsServicePaginationResponse.runtime = protobuf_1.proto3;
PayrollGroupsServicePaginationResponse.typeName = "Scailo.PayrollGroupsServicePaginationResponse";
PayrollGroupsServicePaginationResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
...
PayrollGroupsServiceFilterReq.runtime = protobuf_1.proto3;
PayrollGroupsServiceFilterReq.typeName = "Scailo.PayrollGroupsServiceFilterReq";
PayrollGroupsServiceFilterReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.SORT_ORDER) },
...
PayrollGroupsServiceCountReq.runtime = protobuf_1.proto3;
PayrollGroupsServiceCountReq.typeName = "Scailo.PayrollGroupsServiceCountReq";
PayrollGroupsServiceCountReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 101, name: "creation_timestamp_start", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 102, name: "creation_timestamp_end", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 103, name: "modification_timestamp_start", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
PayrollGroupsServiceSearchAllReq.runtime = protobuf_1.proto3;
PayrollGroupsServiceSearchAllReq.typeName = "Scailo.PayrollGroupsServiceSearchAllReq";
PayrollGroupsServiceSearchAllReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.SORT_ORDER) },
