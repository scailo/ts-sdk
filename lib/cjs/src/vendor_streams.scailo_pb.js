...
(function (VENDOR_STREAM_REF_FROM) {
     ...
     */
    VENDOR_STREAM_REF_FROM[VENDOR_STREAM_REF_FROM["VENDOR_STREAM_REF_FROM_SUPPLY_OFFER"] = 40] = "VENDOR_STREAM_REF_FROM_SUPPLY_OFFER";
...
class LogbookLogVendorStreamLC extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.operation = VENDOR_STREAM_LIFECYCLE.VENDOR_STREAM_LIFECYCLE_ANY_UNSPECIFIED;
        /**
...
LogbookLogVendorStreamLC.runtime = protobuf_1.proto3;
LogbookLogVendorStreamLC.typeName = "Scailo.LogbookLogVendorStreamLC";
LogbookLogVendorStreamLC.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStreamsServiceCreateRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.refFrom = VENDOR_STREAM_REF_FROM.VENDOR_STREAM_REF_FROM_ANY_UNSPECIFIED;
        /**
         ...
         */
        this.assignSelfAsVendorSubscriber = false;
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
VendorStreamsServiceCreateRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceCreateRequest.typeName = "Scailo.VendorStreamsServiceCreateRequest";
VendorStreamsServiceCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
...
VendorStreamsServiceUpdateRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceUpdateRequest.typeName = "Scailo.VendorStreamsServiceUpdateRequest";
VendorStreamsServiceUpdateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStream extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.status = VENDOR_STREAM_LIFECYCLE.VENDOR_STREAM_LIFECYCLE_ANY_UNSPECIFIED;
        /**
...
VendorStream.runtime = protobuf_1.proto3;
VendorStream.typeName = "Scailo.VendorStream";
VendorStream.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
VendorStreamsList.runtime = protobuf_1.proto3;
VendorStreamsList.typeName = "Scailo.VendorStreamsList";
VendorStreamsList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStreamsServicePaginationReq extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.sortKey = VENDOR_STREAM_SORT_KEY.VENDOR_STREAM_SORT_KEY_ID_UNSPECIFIED;
        /**
         * The status of this vendor stream
         *
...
VendorStreamsServicePaginationReq.runtime = protobuf_1.proto3;
VendorStreamsServicePaginationReq.typeName = "Scailo.VendorStreamsServicePaginationReq";
VendorStreamsServicePaginationReq.fields = protobuf_1.proto3.util.newFieldList(() => [
...
VendorStreamsServicePaginationResponse.runtime = protobuf_1.proto3;
VendorStreamsServicePaginationResponse.typeName = "Scailo.VendorStreamsServicePaginationResponse";
VendorStreamsServicePaginationResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStreamsServiceFilterReq extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.vendorSubscriberUserId = protobuf_1.protoInt64.zero;
        protobuf_1.proto3.util.initPartial(data, this);
    }
    static fromBinary(bytes, options) {
...
VendorStreamsServiceFilterReq.runtime = protobuf_1.proto3;
VendorStreamsServiceFilterReq.typeName = "Scailo.VendorStreamsServiceFilterReq";
VendorStreamsServiceFilterReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.SORT_ORDER) },
...
VendorStreamsServiceCountReq.runtime = protobuf_1.proto3;
VendorStreamsServiceCountReq.typeName = "Scailo.VendorStreamsServiceCountReq";
VendorStreamsServiceCountReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 101, name: "creation_timestamp_start", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 102, name: "creation_timestamp_end", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 103, name: "modification_timestamp_start", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
VendorStreamsServiceSearchAllReq.runtime = protobuf_1.proto3;
VendorStreamsServiceSearchAllReq.typeName = "Scailo.VendorStreamsServiceSearchAllReq";
VendorStreamsServiceSearchAllReq.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.SORT_ORDER) },
...
class VendorStreamsServiceMessageCreateRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.messageType = VENDOR_STREAM_MESSAGE_TYPE.VENDOR_STREAM_MESSAGE_TYPE_ANY_UNSPECIFIED;
        /**
         * Stores the vendor stream UUID
         *
         * @generated from field: string vendor_stream_uuid = 10;
         */
        this.vendorStreamUuid = "";
        /**
...
VendorStreamsServiceMessageCreateRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceMessageCreateRequest.typeName = "Scailo.VendorStreamsServiceMessageCreateRequest";
VendorStreamsServiceMessageCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStreamMessage extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.vendorStreamId = protobuf_1.protoInt64.zero;
        /**
         * Stores the optional UUID of the message that this message is a response to
         *
         * @generated from field: string response_to_message_uuid = 11;
...
VendorStreamMessage.runtime = protobuf_1.proto3;
VendorStreamMessage.typeName = "Scailo.VendorStreamMessage";
VendorStreamMessage.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "metadata", kind: "message", T: base_scailo_pb_js_1.EmployeeMetadata },
    { no: 8, name: "message_type", kind: "enum", T: protobuf_1.proto3.getEnumType(VENDOR_STREAM_MESSAGE_TYPE) },
...
VendorStreamMessagesList.runtime = protobuf_1.proto3;
VendorStreamMessagesList.typeName = "Scailo.VendorStreamMessagesList";
VendorStreamMessagesList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
class VendorStreamMessagesSearchRequest extends protobuf_1.Message {
    constructor(data) {
         ...
         */
        this.sortKey = VENDOR_STREAM_MESSAGE_SORT_KEY.VENDOR_STREAM_MESSAGE_SORT_KEY_ID_UNSPECIFIED;
        /**
         * The entity UUID that is to be used to filter records
         *
         * @generated from field: string entity_uuid = 6;
...
VendorStreamMessagesSearchRequest.runtime = protobuf_1.proto3;
VendorStreamMessagesSearchRequest.typeName = "Scailo.VendorStreamMessagesSearchRequest";
VendorStreamMessagesSearchRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "is_active", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.BOOL_FILTER) },
    { no: 2, name: "count", kind: "scalar", T: 3 /* ScalarType.INT64 */ },
    { no: 3, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 4, name: "sort_order", kind: "enum", T: protobuf_1.proto3.getEnumType(base_scailo_pb_js_1.SORT_ORDER) },
...
VendorStreamsServicePaginatedMessagesResponse.runtime = protobuf_1.proto3;
VendorStreamsServicePaginatedMessagesResponse.typeName = "Scailo.VendorStreamsServicePaginatedMessagesResponse";
VendorStreamsServicePaginatedMessagesResponse.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "count", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 2, name: "offset", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 3, name: "total", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
VendorStreamMessageReceipt.runtime = protobuf_1.proto3;
VendorStreamMessageReceipt.typeName = "Scailo.VendorStreamMessageReceipt";
VendorStreamMessageReceipt.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "metadata", kind: "message", T: base_scailo_pb_js_1.EmployeeMetadata },
...
VendorStreamMessageReceiptsList.runtime = protobuf_1.proto3;
VendorStreamMessageReceiptsList.typeName = "Scailo.VendorStreamMessageReceiptsList";
VendorStreamMessageReceiptsList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
VendorStreamsServiceInternalSubscriberCreateRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceInternalSubscriberCreateRequest.typeName = "Scailo.VendorStreamsServiceInternalSubscriberCreateRequest";
VendorStreamsServiceInternalSubscriberCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 10, name: "vendor_stream_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 11, name: "user_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
]);
...
VendorStreamInternalSubscriber.runtime = protobuf_1.proto3;
VendorStreamInternalSubscriber.typeName = "Scailo.VendorStreamInternalSubscriber";
VendorStreamInternalSubscriber.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "metadata", kind: "message", T: base_scailo_pb_js_1.EmployeeMetadata },
...
VendorStreamInternalSubscribersList.runtime = protobuf_1.proto3;
VendorStreamInternalSubscribersList.typeName = "Scailo.VendorStreamInternalSubscribersList";
VendorStreamInternalSubscribersList.fields = protobuf_1.proto3.util.newFieldList(() => [
...
VendorStreamsServiceImportInternalSubscribersRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceImportInternalSubscribersRequest.typeName = "Scailo.VendorStreamsServiceImportInternalSubscribersRequest";
VendorStreamsServiceImportInternalSubscribersRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
...
VendorStreamsServiceVendorSubscriberCreateRequest.runtime = protobuf_1.proto3;
VendorStreamsServiceVendorSubscriberCreateRequest.typeName = "Scailo.VendorStreamsServiceVendorSubscriberCreateRequest";
VendorStreamsServiceVendorSubscriberCreateRequest.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 10, name: "vendor_stream_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
    { no: 11, name: "user_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
]);
...
VendorStreamVendorSubscriber.runtime = protobuf_1.proto3;
VendorStreamVendorSubscriber.typeName = "Scailo.VendorStreamVendorSubscriber";
VendorStreamVendorSubscriber.fields = protobuf_1.proto3.util.newFieldList(() => [
    { no: 1, name: "entity_uuid", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "metadata", kind: "message", T: base_scailo_pb_js_1.EmployeeMetadata },
    { no: 5, name: "user_comment", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 10, name: "vendor_stream_id", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
VendorStreamVendorSubscribersList.runtime = protobuf_1.proto3;
VendorStreamVendorSubscribersList.typeName = "Scailo.VendorStreamVendorSubscribersList";
VendorStreamVendorSubscribersList.fields = protobuf_1.proto3.util.newFieldList(() => [
