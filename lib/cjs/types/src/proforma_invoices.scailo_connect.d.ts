...
export declare const ProformaInvoicesService: {
    ...
    readonly methods: {
         ...
         */
        readonly addMultipleProformaInvoiceItems: {
            readonly name: "AddMultipleProformaInvoiceItems";
            readonly I: typeof ProformaInvoicesServiceMultipleItemsCreateRequest;
            readonly O: typeof IdentifierResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
         ...
         */
        readonly updateProformaInvoiceItemSpecifications: {
            readonly name: "UpdateProformaInvoiceItemSpecifications";
            readonly I: typeof ProformaInvoicesServiceItemSpecificationsUpdateRequest;
            readonly O: typeof IdentifierResponse;
            readonly kind: MethodKind.Unary;
        };
        /**
