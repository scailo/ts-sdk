...
export declare const LeavesRequestsService: {
    ...
    readonly methods: {
         ...
         *
         * @generated from rpc Scailo.LeavesRequestsService.ViewEssentialByID
         */
         ...
         *
         * @generated from rpc Scailo.LeavesRequestsService.ViewEssentialByUUID
         */
         ...
         *
         * @generated from rpc Scailo.LeavesRequestsService.ViewFromIDs
         */
