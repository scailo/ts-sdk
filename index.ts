...
*/
export function getScailoClientForTransactionalEmailsService(transport: Transport): Client<typeof TransactionalEmailsService> {
    return createClient(TransactionalEmailsService, transport);
}
